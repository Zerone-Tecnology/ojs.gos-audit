<?php return array (
  ...
  'common.homePageHeader.altText' => 'Заголовок домашньої сторінки',
  'common.journalHomepageImage.altText' => 'Зображення домашньої сторінки журналу',
  ...
  'common.publishedSubmission' => 'Стаття',
  'common.publishedSubmissions' => 'Статті',
  ...
  'user.register.contextsPrompt' => 'У яких журналах на цьому сайті Ви хочете зареєструватися?',
  ...
  'user.noRoles.chooseJournal' => 'Ваш обліковий запис зараз не асоційований із жодним журналом. Будь ласка, оберіть журнал:',
  ...
  'issue.return' => 'Повернутися до даних про випуск',
  ...
  'admin.auth.defaultSourceDescription' => '<p>Визначення основного джерела аутентифікації, іншого ніж OJS, матиме наступні наслідки:</p>
<ul>
...
<p>Система не може автоматично перейменувати файл конфігурації. Для застосування змін конфігурації Ви повинні відкрити <tt>config.inc.php</tt> у текстовому редакторі та замінити його зміст змістом текстового поля, наведеного нижче.</p>',
  ...
  'plugins.categories.viewableFiles' => 'Модулі гранок статей',
  'plugins.categories.viewableFiles.description' => 'Модулі гранок статей додають підтримку відображення документів різних типів як гранок статті.',
  'plugins.categories.auth.description' => 'Модулі авторизації дозволяють Open Journal Systems делегувати завдання щодо аутентифікації користувачів іншим системам, таким як сервери LDAP.',
  'plugins.categories.generic.description' => 'Загальні модулі дозволяють багатьма шляхами розширити функціональність Open Journal Systems.',
  'manager.setup.lockssDescription' => 'Open Journal Systems підтримує систему <a href="http://www.lockss.org/" target="_blank">LOCKSS</a> (Lots of Copies Keep Stuff Safe) для захищеного та надійного архівування журналу. LOCKSS - це програмний засіб з відкритим вихідним кодом, розроблений Бібліотекою Стенфордського університету, який дозволяє бібліотекам забезпечувати збереження окремих веб-журналів, регулярно перевіряючи веб-сайти зареєстрованих журналів на наявність нового опублікованого контенту та архівуючи його. Кожен архів постійно перевіряється на відповідність з іншими; якщо контент виявляється пошкодженим або втраченим, інші архіви використовуються для його відновлення.
<br /><br />
...
Встановлення підтримки LOCKSS для Open Journal Systems не повинно здійснюватись до того часу, доки видавничий процес не розгорнутий повністю.',
  'manager.setup.porticoDescription' => 'Portico - це некомерційний сервіс, призначений для збереження цифрових публікацій, у тому числі електронних журналів, книг та оцифрованих історичних колекцій. Якщо ваш журнал підписав контракт з Portico, увімкніть тут необхідні налаштування:',
  'manager.setup.authorCopyrightNotice.sample' => '<h3>Запропоноване Положення про авторські права Creative Commons</h3>
...
<ol type="a">
  ...
  'manager.setup.subjectClassificationDescription' => 'В журналі використовуватиметься доступна у веб-середовищі класифікаційна система.<br />
...
За бажанням Ви можете повідомити користувачу причину деактивації його облікового запису.',
  'manager.people.noAdministrativeRights' => 'Вибачте, але Ви не маєте прав для управління цим користувачем, з огляду на те, що:
	       <ul>
  ...
  'sectionEditor.noneAssigned' => 'Немає  призначених матеріалів.',
  ...
  'submission.layout.galley.remotelyHostedContent' => 'Ця гранка буде доступна на окремому веб-сайті.',
  ...
  'reviewer.article.downloadSubmission' => 'Натискайте на імена файлів, щоб завантажити та переглянути (з екрану або у роздрукованому вигляді) файли, асоційовані з цим поданням.',
  ...
  'reviewer.article.selectRecommendation' => 'Для завершення процесу рецензування оберіть рекомендацію та надішліть рецензію. Перед тим, як обрати рекомендацію, Ви повинні внести рецензію або вивантажити файл.',
  'reviewer.article.selectRecommendation.byEditor' => 'Задати, чи змінити рекомендацію рецензента.',
  'reviewer.article.mustSelectDecision' => 'Рекомендація не обрана. Ви повинні обрати рекомендацію щодо подання.',
  ...
  'copyeditor.article.copyeditorFinalFile' => 'Файл літ. редактора',
...
<li>Після того, як подання буде вивантажене, натисніть кнопку "Зберегти та продовжити" внизу цієї сторінки.</li>
  ...
  'submission.copyedit.mustUploadFileForInitialCopyedit' => 'Лист запиту не може бути надіслатий, доки у розділі "Рішення редактора" сторінки "Рецензування" не обраний файл редактора.',
  'submission.copyedit.mustUploadFileForCopyedit' => 'Лист запиту не може бути надіслатий, доки не вивантажений файл для літературного редагування.',
...
(після запису можна буде додати інші коментарі.)',
  ...
  'user.register.noJournals' => 'На цьому сайті немає журналів, у яких Ви можете зареєструватись.',
  ...
  'user.register.reviewerDescriptionNoInterests' => 'Дає свою згоду на рецензування рукописів для журналу.',
  'user.register.reviewerDescription' => 'Дає свою згоду на рецензування рукописів для редакції.',
  ...
  'user.register.form.missingSiteConsent' => 'Ви повинні погодитися з політикою конфіденційності даного сайту.',
  'user.subscriptions.mySubscriptions' => 'Мої передплати',
  'user.subscriptions.subscriptionStatus' => 'Статус передплати',
  'user.subscriptions.statusInformation' => 'Нижче відображений список активних та завершених передплат з датами завершення кожної з них. Крім того, до інформації про кожну передплату може бути додана наступна інформація про її статус.',
  ...
  'user.subscriptions.status.needsApprovalDescription' => 'Передплата буде активована після після її перегляду менеджером передплати',
  ...
  'user.subscriptions.form.domainInstructions' => 'Якщо тут вказується доменне ім\'я, вказувати діапазон IP-адрес необов\'язково. <br/>Доменні імена повинні бути коректними (наприклад, lib.sfu.ca).',
  ...
  'user.subscriptions.form.ipRangeInstructions' => 'Якщо тут вказується діапазон IP-адрес, вказувати домен необов\'язково. <br />Можуть вказуватись окремі IP-адреси (наприклад, 142.58.103.1), звичайні діапазони IP-адрес (наприклад, 142.58.103.1 - 142.58.103.4), діапазони IP-адрес з символами \'*\' (наприклад, 142.58.*.*) та IP-маски CIDR (наприклад, 142.58.100.0/24).',
  ...
  'search.authorDetails' => 'Інформація про автора',
...
<li>Використовуйте у термінах символ <strong>*</strong> як метасимвол, що позначає будь-яку послідовність символів; наприклад, за запитом <em>соці*</em> будуть знайдені документи, що містять слова "соціальний", "соціалістичний", "соціологічний" тощо</li>
  ...
  'article.pluginMissing' => '<p>Обраний Вами файл PDF повинен завантажуватися тут, якщо у Вашого веб-браузера встановлений модуль для читання PDF (наприклад, остання версія <a href="https://get.adobe.com/reader/">Adobe Acrobat Reader</a>).</p>',
  'article.nonpdf.title' => 'Завантаження статті',
  'article.nonpdf.note' => 'Обраний Вами файл почне завантажуватись автоматично. Зауважте, що для перегляду цього файлу може знадобитись спеціалізоване програмне забезпечення.<br /><br />Якщо файл не завантажився автоматично, <a href="{$url}">натисніть сюди</a>.',
  'site.journalsHosted' => 'Журнали, розміщені на цьому сайті',
  ...
  'about.onlineSubmissions' => 'Подання статей',
  ...
  'about.submissionPreparationChecklist.description' => 'Під час подання рукопису до журналу автори повинні підтвердити його відповідність всім встановленим вимогам, вказаним нижче. В разі виявлення невідповідності поданої роботи пунктам цих вимог редакція повертатиме авторам матеріали на доопрацювання.',
  ...
  'about.authorSelfArchive' => 'Депонування робіт у відкритих архівах',
  ...
  'about.aboutThisPublishingSystem' => 'Про цю видавничу систему',
  ...
  'gifts.buyer' => 'Від',
  'gifts.buyerDescription' => 'Від кого цей подарунок?',
  'gifts.recipient' => 'Для',
  'gifts.recipientDescription' => 'Для кого цей подарунок?',
  'gifts.thankYou' => 'Дякую',
  'gifts.thankYouMessage' => 'Процес придбання подарунку завершений. Коли Ваш платіж буде оброблений, Ви отримаєте копію листа з подарунком, надіслану адресату.',
  'gifts.purchaseGiftIndividualSubscription' => 'Подарункова передплата',
  'gifts.subscriptionFormIntroduction' => 'Будь ласка, заповніть форму нижче. Надана контактна інформація та Ваша супровідна записка до подарунку будуть включені до листа отримувачу, щоб інформувати його про нову подарункову передплату (Ви також отримаєте копію цього листа).',
  'gifts.details' => 'Інформація про подарунок',
  'gifts.detailsDescription' => 'Будь ласка, оберіть один з подарунків нижче та напишіть особисте повідомлення, яке буде відправлено отримувачу (Ви також отримаєте копію цього листа).',
  'gifts.gift' => 'Подарунок',
  'gifts.noteTitle' => 'Заголовок',
  'gifts.note' => 'Супровідна записка до подарунку',
  'gifts.noteTitleRequired' => 'Будь ласка, вкажіть заголовок своєї супровідної записки.',
  'gifts.noteRequired' => 'Будь ласка, напишіть особисте повідомлення.',
  'gifts.localeRequired' => 'Будь ласка, оберіть мову Вашого особистого повідомлення.',
  'gifts.myGifts' => 'Мої подарунки',
  'gifts.manageMyGifts' => 'Керувати моїми подарунками',
  'gifts.redeemGift' => 'Активувати подарунок',
  'gifts.status.notRedeemed' => 'Доступний',
  'gifts.status.redeemed' => 'Активований',
  'gifts.status.redeemGift' => 'Активувати подарунок',
  'gifts.subscriptions' => 'Передплати',
  'gifts.subscriptionsDescription' => 'Ваша поточна передплата (якщо така є) буде замінена активованою тут подарунковою передплатою. Передплата розпочнеться з дня активації і буде активною протягом стандартного терміну передплати відповідного типу.',
  'gifts.purchaseGiftSubscription' => 'Купити подарункову передплату',
  'gifts.giftSubscriptionsAvailable' => 'Також доступні подарункові передплати. Подарункові передплати можуть бути активовані у будь-який час. Придбання передплати у подарунок - це чудовий спосіб підтримати цей журнал.',
  'gifts.noSubscriptions' => 'Немає подарункових передплат',
  'gifts.giftRedeemed' => 'Подарунок був успішно активований.',
  'gifts.noGiftToRedeem' => 'Цей подарунок не доступний для активації.',
  'gifts.giftAlreadyRedeemed' => 'Цей подарунок вже був активований.',
  'gifts.giftNotValid' => 'Цей подарунок недійсний, він не може бути активований.',
  'gifts.subscriptionTypeNotValid' => 'Тип передплати для цього подарунку недійсний. Будь ласка, сконтактуйте з менеджером передплати.',
  'gifts.subscriptionNonExpiring' => 'Подарунок не був активований, оскільки Ви вже маєте безстрокову передплату на цей журнал.',
  ...
  'payment.alreadyPaidMessage' => 'Якщо Ви вже надіслали свій платіж журналу, оберіть цей пункт та завершіть процес подання. Подання не буде розглядатись поки не надійде платіж. Для отримання інструкцій щодо здійснення платежів натисніть кнопку "Сплатити зараз".',
  ...
  'payment.type.gift' => 'Подарунок',
  'payment.type.gift.subscription' => 'Передплата',
  'payment.requestPublicationFee' => 'Зробити запит на оплату публікації ({$feeAmount})',
  'payment.notFound' => 'Отримано запит на оплату, але термін дії запиту минув. Зверніться до менеджера журналіу, щоб дізнатись більше.',
...
<p>Перед тим, як продовжити, <strong>наполегливо рекомендуємо</strong> зробити резервну копію Вашої бази даних, файлових тек та теки інсталяції OJS.</p>
...
Зараз Ваш сервер має підтримку mbstring: <strong>{$supportsMBString}</strong>',
  ...
  'installer.additionalLocalesInstructions' => 'Оберіть будь-які додаткові мови, які будуть підтримуватись цією системою. Ці мови будуть доступні для використання журналами, розміщеними на цьому сайті. Додаткові мови можуть встановлюватись у будь-який час з інтерфейсу адміністратора сайту.',
...
<p>Програма інсталяції не здатна самостійно вносити зміни у файл конфігурації. Перш ніж почати використовувати систему, будь ласка, відкрийте файл <tt>config.inc.php</tt> у текстовому редакторі та замініть його зміст на зміст текстових полів, наведений нижче.</p>',
  'installer.installationComplete' => '<p>Інсталяція OJS успішно завершена.</p>
<p>Для того, щоб почати використовувати систему <a href="{$loginUrl}">увійдіть на сайт</a> з іменем користувача та паролем, вказаними на попередній сторінці.</p>
<p>Якщо Ви хочете стати частиною спільноти PKP, Ви можете:</p>
<ol>
	<li>Прочитати <a href="http://pkp.sfu.ca/blog" target="_new">Блог PKP</a> і підписатися на <a href="http://pkp.sfu.ca/blog/feed" target="_new">RSS feed</a> для отримання новин та оновлень.</li>
	<li>Відвідайте<a href="http://forum.pkp.sfu.ca" target="_new">Форум Підтримки</a> якщо у вас є запитання чи коментарі.</li>
</ol>',
  'installer.upgradeComplete' => '<p>Оновлення OJS до версії {$version} завершене успішно.</p>
...
<p>Якщо Ви ще не зареєструвались, але хочете отримувати новини та оновлення, <strong>будь ласка, зареєструйтеся за адресою <a href="http://pkp.sfu.ca/ojs/register" target="_new">http://pkp.sfu.ca/ojs/register</a>.</strong> Якщо виникли запитання або коментарі, будь ласка, завітайте на <a href="http://forum.pkp.sfu.ca" target="_new">форум підтримки</a>.</p>',
  'site.upgradeAvailable.admin' => 'Доступна нова версія OJS! Зараз Ви використовуєте OJS {$currentVersion}. Найновіша версія OJS {$latestVersion}. Будь ласка, завітайте на <a href="http://pkp.sfu.ca/ojs_download" target="_new">цю сторінку</a>, щоб завантажити найновішу версію системи та знайти інструкції щодо оновлення.',
  ...
  'log.review.reviewReinitiated' => 'Був повторно розпочатий {$round} раунд рецензування подання {$submissionId} фахівцем {$reviewerName}.',
  'log.review.reviewCleared' => 'Були скасовані дані про {$round} раунд рецензування подання {$submissionId} фахівцем {$reviewerName}.',
  ...
  'log.review.reviewerFile' => 'Файл рецензента був вивантажений.',
  ...
  'log.copyedit.copyeditorFile' => 'Версія файлу літературного редактора була вивантажена.',
  'log.copyedit.authorFile' => 'Версія файлу подання, відредагована автором, була вивантажена.',
  ...
  'log.editor.editorFile' => 'Файл редакційної версії подання був вивантажений.',
  'log.editor.archived' => 'Подання {$submissionId} було переміщене до архіву.',
  'log.editor.restored' => 'Подання {$submissionId} було відновлене у редакційній черзі.',
  ...
  'rt.admin.settings' => 'Налаштування інструментів читання',
  'rt.admin.settings.description' => 'Інструменти читання з\'являються на панелі поруч з опублікованими об\'єктами індексованих розділів журналу. Інструментарій читання складається з двох наборів: поданого нижче набору інструментів, які допомагають працювати з опублікованими об\'єктами, а також впорядкованого за галузями знань набору інструментів, які надають доступ до споріднених об\'єктів.',
  'rt.admin.settings.enableReadingTools' => 'Включити інструментарій читання для визначених розділів журналу.',
  'rt.admin.settings.relatedItems' => 'Галузь',
  'rt.admin.settings.relatedItemsLink' => 'Для перегляду, додавання, коригування або видалення пунктів списку споріднених об\'єктів для кожної з галузей знань, див. <a href="{$relatedItemsLink}" class="action">Набори споріднених об\'єктів</a>.',
  'rt.admin.options' => 'Інструменти читання статей',
  'rt.admin.relatedItems' => 'Інструменти пошуку споріднених об\'єктів',
  'rt.admin.settings.addComment' => 'Додати коментар (дозволяє читачам надсилати коментарі, які менеджер журналу може видаляти).',
  'rt.admin.settings.addComment.authenticated' => 'Коментарі приймаються лише від зареєстрованих користувачів, анонімність не дозволяється.',
  'rt.admin.settings.addComment.anonymous' => 'Коментарі приймаються лише від зареєстрованих користувачів, анонімність дозволяється.',
  'rt.admin.settings.addComment.unauthenticated' => 'Незареєстровані користувачі можуть надсилати коментарі, анонімність дозволяється.',
  'rt.admin.validateUrls.description' => 'Нижче відображені адреси URL пошукових сайтів, які, ймовірно, не є коректними.<br />
...
Негативні результати перевірки можуть бути пов\'язані з тим, що сайт вимагає надсилання даних у формі.',
  ...
  'notification.type.site' => 'Події сайту',
  ...
  'user.authorization.noContext' => 'Немає журналу в контексті!',
  ...
  'manager.setup.copyrightNotice.sample' => '<h3>Приклади сповіщень про передачу авторських прав на основі ліцензій Creative Commons</h3>
...
<ol type="a">
	...
	<li>Авторам дозволяється розміщувати їх роботу в мережі Інтернет (наприклад, в університетському репозитарії або на персональному веб-сайті) до і після розгляду її цим журналом, так як це може призвести до продуктивного діалогу і дискусії, а також до більшої кількості посилань на дану опубліковану роботу (Дивіться <a target="_new" href="http://opcit.eprints.org/oacitation-biblio.html">Ефект Відкритого Доступу</a>).</li>
</ol>

<h4>2. Приклад політики для журналів, які пропонують Відкладений (відтермінований) відкритий доступ</h4>
Автори, які публікуються у даному журналі, погоджуються з наступними умовами:
<ol type="a">
	<li>Автори зберігають за собою авторські права на роботу і передають журналу право першої публікації разом з роботою,  ліцензуючи її після закінчення терміну [ВКАЖІТЬ ТЕРМІН ЧАСУ] після публікації, на умовах<a target="_new" href="http://creativecommons.org/licenses/by/3.0/">ліцензії Creative Commons Attribution</a>, яка дозволяє іншим розповсюджувати дану роботу з обов\'язковим вказуванням авторства даної роботи і посиланням на оригінальну статтю у цьому журналі.</li>
