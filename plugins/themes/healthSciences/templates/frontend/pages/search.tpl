	...
	<div class="container">
		<div class="page-wrapper">
			...
			<div class="page-content">
				...
				<div class="col-lg-10 search-col-filters">
						...
						<form class="form-search" method="get" action="{$smarty.capture.searchFormUrl|strtok:"?"|escape}">
							...
							<div class="form-group form-group-date-from">
								...
								<div class="form-control-date">
									{html_select_date id="search_month" class="form-control" prefix="dateFrom" time=$dateFrom start_year=$yearStart end_year=$yearEnd year_empty="" month_empty="" day_empty="" field_order="YMD"}
								</div>
							</div>
							<div class="form-group form-group-date-to">
								...
								<div class="form-control-date">
									{html_select_date id="search_month" class="form-control" prefix="dateTo" time=$dateTo start_year=$yearStart end_year=$yearEnd year_empty="" month_empty="" day_empty="" field_order="YMD"}
								</div>
							</div>
